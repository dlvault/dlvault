...
function withinDays(addedAt: string | null | undefined, days: number): boolean {
...
/* Mobile: roughly halve the strip height — drop the verbose delta sub-line, tighten */
@media (max-width: 768px) {
  .lx-stat { padding: 10px 12px; gap: 3px; }
  .lx-stat-value { font-size: 19px; }
  .lx-stat-value .unit { font-size: 11px; }
  .lx-stat-delta { display: none; }
}
</style>
