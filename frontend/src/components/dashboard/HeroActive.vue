      ...
      <div class="hero-active">
        ...
        <div class="hero-meta">
          <div class="hero-eyebrow">
            <span class="dot"></span>
            Downloading{{ activeCount > 1 ? ' · ' + activeIndex + ' von ' + activeCount + ' aktiv' : '' }}
          </div>
          <h2 class="hero-title">
          ...
          <div class="hero-strip">
            ...
            <div v-if="speedLimitDisplay" class="hero-strip-item">
              <div class="lbl">Speed-Limit</div>
              <div class="val">{{ speedLimitDisplay }}</div>
            </div>
          </div>
        </div>
      </div>
