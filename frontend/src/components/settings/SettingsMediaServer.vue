<template>
  ...
  <SettingsSection v-if="isJellyfin" label="Jellyfin Authentication">
    ...
    >
      <SecretInput v-model="settings['jellyfin.api_key']" setting-key="jellyfin.api_key" placeholder="API Key" />
    </SettingsRow>
  </SettingsSection>
  ...
  <SettingsSection v-else label="Plex Server Authentication">
    ...
    >
      <SecretInput v-model="settings['plex.token']" setting-key="plex.token" placeholder="Plex Token" />
    </SettingsRow>
  </SettingsSection>
</template>
