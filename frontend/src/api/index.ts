...
export const getDownloads = () => api.get('/sync/downloads');
export const getStats = (days?: number) => api.get('/sync/stats', { params: days ? { days } : {} });
...
export const getJDState = () => api.get('/downloads/state');
...
// SSE Events
// Plugins
export type PluginPermission = 'browser' | 'secrets' | 'filesystem';
