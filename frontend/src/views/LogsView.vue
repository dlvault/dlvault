...
const { paginatedItems: pagedLogs, page, totalPages, hasNextPage, hasPrevPage, nextPage, prevPage, itemsPerPage, resetPage } = usePagination(filteredLogs, 50);

// Narrowing the list gives it a new "top" — without this, searching from page 5
// kept showing matches 201-250 and the actual hits were invisible on page 1.
watch([debouncedSearch, actionFilter], () => resetPage());
