...
const STAGE_META: Record<string, { mono: string; color: string }> = {
  ...
  not_available:    { mono: 'NOCH NICHT VERFÜGBAR',    color: 'var(--stage-not_available)' },
...
const chips = computed(() => {
  ...
  return [
    ...
    { key: 'quality_mismatch', label: 'Anforderungen nicht erfüllt', count: counts.quality_mismatch || 0,    color: 'var(--stage-quality_mismatch)' },
