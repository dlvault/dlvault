<template>
  <div>
    ...
    <DetailPanel
      ...
      @close="closePanel"
      @open-in-jellyfin="onOpenInJellyfin"
...
// Match a library item back to a queue movie row for full metadata/pipeline.
...
function onOpenInJellyfin() {
  toast.value?.add('Im Media Server öffnen ist noch nicht verfügbar', 'info');
}

function onOpenFolder() {
  toast.value?.add('Ordner anzeigen ist noch nicht verfügbar', 'info');
}
