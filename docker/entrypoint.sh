...
# The bundled FlareSolverr patches/caches its chromedriver under its app dir at
# runtime; make it writable by the (PUID/PGID-remapped) app user. Cheap — ~22 MB.
chown -R "$PUID:$PGID" /opt/flaresolverr 2>/dev/null || true
