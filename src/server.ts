...
const server = app.listen(PORT, async () => {
  ...
  if (jdownloaderService.isConfigured()) {
    ...
    if (twoCaptchaKey) {
      ...
      logger.warn('No 2Captcha API key set (Settings -> Plugin-Secrets) — filecrypt containers behind a circle/cutcaptcha challenge cannot be solved automatically. PoW-protected containers still work without it.');
    }
  }
