...
const { testDb } = vi.hoisted(() => {
  ...
  testDb.exec(`
    ...
    -- Mirrors the production schema so the query-plan assertion below is
    -- meaningful: isReleaseBlocklisted compares LOWER(release_name), which the
    -- plain column index cannot serve.
