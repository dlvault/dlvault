...
describe('validateManifest', () => {
  ...
  it('rejects an unknown mediaType', () => {
    expect(() => validateManifest({ ...minimal, mediaTypes: ['podcast'] })).toThrow(/movie.*show.*music/);
  });

  it('accepts the music mediaType', () => {
    expect(() => validateManifest({ ...minimal, mediaTypes: ['music'] })).not.toThrow();
  });
